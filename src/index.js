...
var config = {
  ...
  scene: [MiniJeuDarties, niveauMeyer,selection,videoggP,chargementP,chargement1, chargement2, chargement3,puzzle, minijeuAbdellah , principal,   niveauJousset, niveauDarties, niveauAbdellah]
};
